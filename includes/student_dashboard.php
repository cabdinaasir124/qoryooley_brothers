                                ...
                                <div class="card-body">
                                    <div class="d-flex align-content-center justify-content-between">
                                        <div class="d-flex align-items-start flex-column h-100">
                                            ...
                                            <a href="#" class="btn btn-sm btn-danger">View All Classes</a>
                                        </div>
                                        <div class="">
                            ...
                            <div class="card mb-0">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-baseline mb-2">
                                        <div class="fs-22 mb-0 me-2 fw-semibold text-dark">120</div>
                                        <div class="me-auto">
                        ...
                        <div class="col-md-6 col-xl-6">
                            <div class="card mb-0">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-baseline mb-2">
                                        <div class="fs-22 mb-0 me-2 fw-semibold text-dark">92%</div>
                                        <div class="me-auto">
                        ...
                        <div class="col-md-6 col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="fs-16 mb-1">Assignments</div>
                                    </div>

                                    <div class="d-flex align-items-baseline mb-2">
                                        <div class="fs-22 mb-0 me-2 fw-semibold text-dark">15 Pending</div>
                                        <div class="me-auto">
                                            <span class="text-primary d-inline-flex align-items-center">
                                                12%
                                                <i data-feather="trending-up" class="ms-1" style="height: 20px; width: 20px;"></i>
                        ...
                        <div class="col-md-6 col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-baseline mb-2">
                                        <div class="fs-22 mb-0 me-2 fw-semibold text-dark">8</div>
                                        <div class="me-auto">
                                            <span class="text-primary d-inline-flex align-items-center">
                                                4%
                                                <i data-feather="trending-up" class="ms-1" style="height: 20px; width: 20px;"></i>
                                ...
                                <div class="earnings-profit border-start border-dashed border-primary-subtle mt-md-0 mt-2">
                                    <div class="ms-md-3">
                                        <div class="d-flex gap-2 align-items-center">
                                            ...
                                            <h6 class="mb-0 fw-normal fs-16">Messages</h6>
                                        </div>
                                        <h4 class="my-2 text-dark">23</h4>
                                        <div class="progress w-75" style="height:6px">
                                ...
                                <div class="earnings-expense border-start border-dashed border-primary-subtle mt-md-0 mt-2">
                                    <div class="ms-md-3">
                                        <div class="d-flex gap-2 align-items-center">
                                            ...
                                            <h6 class="mb-0 fw-normal fs-16">Upcoming Exams</h6>
                                        </div>
                                        <h4 class="my-2 text-dark">3</h4>
                                        <div class="progress w-75" style="height:6px">
