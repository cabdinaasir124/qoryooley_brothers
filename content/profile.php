                                    ...
                                    <div class="card-body">
                                        <div class="align-items-center">
                                            ...
                                            <div class="overflow-hidden ms-md-4 ms-0">
                                                <h4 class="m-0 text-dark fs-20 mt-2 mt-md-0" id="user-name">Loading...</h4>
                                                    <p class="my-1 text-muted fs-16">Modern School System User Panel</p>
                                                <span class="fs-15"><i class="mdi mdi-account me-2 align-middle"></i>Role: <span id="user-role" class="badge bg-primary-subtle text-primary px-2 py-1 fs-13 fw-normal">loading...</span></span>
                                            </div>
                                            </div>
